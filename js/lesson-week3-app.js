/* lesson-week3-app.js — wires buttons, modal, timer, font toggle
   Depends on: content-week3.js, ui-helpers.js
*/
(function(){
  ...
  const updateTimer = () => {
    ...
    const ss = String(remaining%60)).padStart(2,'0'); // typo fix: extra )
  };

  // Fix the small typo and implement:
