...
const LESSONS = [
  ...
  { id:'w3', title:'الأسبوع ٣: طاقة الرياح — العنفة وقياسات V/I',
    ...
    { id:'w4', title:'الأسبوع ٤: الدرس الثاني — تطبيقات الطاقة النظيفة (تطبيقات طاقة الرياح)',
    href:'html/lesson-week4-wind-energy-applications.html', emoji:'🌬️',
    desc:'أهمية/استخدامات الرياح قديمًا وحديثًا + إيقاف العنفات + الأنواع والمناطق + بطاقات مفاهيم.', tags:['رياح','تطبيقات','مفاهيم','3D','Scratch'] },
  ...
  { id:'w1-student', type:'student', title:'دليل الطالب — الطاقة النظيفة (الأسبوع ١)',
	...
	{ id:'w2-student', type:'student', title:'دليل الطالب — الطاقة النظيفة (الأسبوع ٢)',
  href:'html/lesson-week2-student.html', emoji:'📘',
  desc:'ملخّصات مركّزة: تعريف، أمثلة، إيجابيات، مصطلحات، وجدول الاستخدامات قديمًا/حديثًا.',
  tags:['Student','Review','Energy'] },
  
  { id:'w3-student', type:'student', title:'دليل الطالب — طاقة الرياح (الأسبوع ٣)',
  href:'html/lesson-week3-student.html', emoji:'📘',
  desc:'تعريف العنفة، الفرق عن المروحة، DMM، شدة التيار، فرق الجهد، مبدأ العمل، سؤال تفكير.',
  tags:['Student','Review','Wind','V/I'] }
