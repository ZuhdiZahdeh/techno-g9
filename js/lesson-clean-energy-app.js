/* lesson-clean-energy-app.js
   Wires buttons, timer, font toggle, print
   Depends on: content-clean-energy.js, ui-helpers.js
*/
(function(){
  ...
  $$('[data-open]').forEach(btn=>{
    btn.addEventListener('click', ()=>{
      ...
      const entry = window.CONTENT[key];
      if(!entry) return;
  ...
  // Focus 5-min timer with Arabic digits
